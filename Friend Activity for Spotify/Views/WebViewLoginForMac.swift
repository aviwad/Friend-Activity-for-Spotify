...
struct WebViewForMac : UIViewRepresentable {
...
struct WebViewLoginForMac: View {
    ...
    let removeEverythingBesidesGoogleScript = "var elements = document.querySelectorAll('[data-testid=\"google-login\"]'); for (let element of elements) { element.style.display = \"none\"; }; elements = document.querySelectorAll('[data-testid=\"apple-login\"]'); for (let element of elements) { element.style.display = \"none\"; };"
    var body: some View {
        VStack {
